...
#define I2C_LEDS (Notify_LED_ToshibaLED_I2C_Internal | Notify_LED_ToshibaLED_I2C_External | \
                  Notify_LED_NCP5623_I2C_Internal | Notify_LED_NCP5623_I2C_External|Notify_LED_ZUAV_I2C_Internal|Notify_LED_ZUAV_PWM_Internal)
...
void AP_Notify::add_backends(void)
{
    ...
    for (uint32_t i = 1; i < Notify_LED_MAX; i = i << 1) {
        switch(_led_type & i) {
            ...
            case Notify_LED_ToshibaLED_I2C_External:
    			...
    			//注意这里先换成IIC2
    	    case Notify_LED_ZUAV_I2C_Internal: //256
    //				ADD_BACKEND(new ToshibaLED_I2C(TOSHIBA_LED_I2C2_BUS_EXTERNAL)); //0x03
    				...
    				break;
    	    case Notify_LED_ZUAV_PWM_Internal:
